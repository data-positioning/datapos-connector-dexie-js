...
function uo() {
  return br || (br = 1, (function(ye, R) {
    ((N, P) => {
      ...
      var N = function(e, t) {
        return (N = Object.setPrototypeOf || ({ __proto__: [] } instanceof Array ? function(n, r) {
          n.__proto__ = r;
        } : function(n, r) {
      ...
      var A = typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : typeof window < "u" ? window : oo, z = Object.keys, F = Array.isArray;
      function X(e, t) {
      ...
      function Be(e, t) {
        typeof t == "function" && (t = t(ae(e))), (typeof Reflect > "u" ? z : Reflect.ownKeys)(t).forEach(function(n) {
          me(e, n, t[n]);
        });
      }
...
`);
      ...
      }, {}), Cr = Fe, S = re.reduce(function(e, t) {
        var n = t + "Error";
        function r(o, i) {
 ...
 ` + i : ""), this.inner = i || null) : typeof o == "object" && (this.message = "".concat(o.name, " ").concat(o.message), this.inner = o) : (this.message = Er[t] || n, this.inner = null);
      ...
      }, {}), qn = (S.Syntax = SyntaxError, S.Type = TypeError, S.Range = RangeError, he.reduce(function(e, t) {
        return e[t + "Error"] = S[t], e;
      }, {}));
      he = re.reduce(function(e, t) {
        return ["Syntax", "Type", "Range"].indexOf(t) === -1 && (e[t + "Error"] = S[t]), e;
      }, {});
      function $() {
      }
      function Ze(e) {
      ...
      var et = {}, Nn = 100, tt = typeof Promise > "u" ? [] : (re = Promise.resolve(), typeof crypto < "u" && crypto.subtle ? [tt = crypto.subtle.digest("SHA-512", new Uint8Array([0])), ae(tt), re] : [re, ae(re), re]), re = tt[0], Ge = tt[1], Ge = Ge && Ge.then, Ke = re && re.constructor, Wt = !!tt[2], nt = function(e, t) {
        rt.push([e, t]), yt && (queueMicrotask(Rr), yt = !1);
      }, Qt = !0, yt = !0, je = [], mt = [], Gt = Ze, ve = { id: "global", global: !0, ref: 0, unhandleds: [], onunhandled: $, pgp: !1, env: {}, finalize: $ }, I = ve, rt = [], Ie = 0, vt = [];
      function E(e) {
      ...
      function xt(e) {
        return J.echoes && e && e.constructor === Ke ? ($e(), e.then(function(t) {
          return ge(), t;
        }, function(t) {
          return ge(), G(t);
        })) : e;
      ...
      function we(e, t) {
        ...
        }.bind(null, e) : Br), e !== I && (I = e, o === ve && (ve.env = Ln()), Wt) && (n = ve.env.Promise, r = e.env, o.global || e.global) && (Object.defineProperty(A, "Promise", r.PromiseProp), n.all = r.all, n.race = r.race, n.resolve = r.resolve, n.reject = r.reject, r.allSettled && (n.allSettled = r.allSettled), r.any) && (n.any = r.any);
      }
      function Ln() {
        var e = A.Promise;
        return Wt ? { Promise: e, PromiseProp: Object.getOwnPropertyDescriptor(A, "Promise"), all: e.all, race: e.race, allSettled: e.allSettled, any: e.any, resolve: e.resolve, reject: e.reject } : {};
      }
      ...
      var G = E.reject, Ae = "￿", de = "Invalid key provided. Keys must be of type string, number, Date or Array<string | number | Date>.", zn = "String expected.", Ve = [], kt = "__dbnames", tn = "readonly", nn = "readwrite";
      function De(e, t) {
        return e ? t ? function() {
      ...
      function Vn() {
        throw S.Type("Entity instances must never be new:ed. Instances are generated by the framework bypassing the constructor.");
      }
      function B(e, t) {
        try {
          var n = Yn(e), r = Yn(t);
      ...
      Qn.prototype.execute = function(e) {
        ...
        if (t.add !== void 0) {
          var n = t.add;
          if (F(n)) return T(T([], F(e) ? e : [], !0), n).sort();
      ...
      V.prototype._trans = function(e, t, n) {
        ...
        function a(m, f, s) {
          ...
          throw new S.NotFound("Table " + o + " not part of transaction");
        }
        var u = Ue();
        try {
          var l = r && r.db._novip === this.db._novip ? r === I.trans ? r._promise(e, a, n) : be(function() {
            ...
            if (f._state.openComplete) return G(new S.DatabaseClosed(f._state.dbOpenError));
            if (!f._state.isBeingOpened) {
              if (!f._state.autoOpen) return G(new S.DatabaseClosed());
              f.open().catch($);
            }
        ...
        var n = this;
        return e && e.constructor === Object ? this.where(e).first(t) : e == null ? G(new S.Type("Invalid argument to Table.get()")) : this._trans("readonly", function(r) {
        ...
        for (var t = this.db, n = this.name, r = ((this.schema.mappedClass = e).prototype instanceof Vn && (e = ((a) => {
          ...
          return N(u, l), u.prototype = l === null ? Object.create(l) : (m.prototype = l.prototype, new m()), Object.defineProperty(f.prototype, "db", { get: function() {
            return t;
        ...
        return typeof e != "object" || F(e) ? this.where(":id").equals(e).modify(t) : (e = le(e, this.schema.primKey.keyPath)) === void 0 ? G(new S.InvalidArgument("Given object does not contain its primary key")) : this.where(":id").equals(e).modify(t);
        ...
        return this._trans("readwrite", function(a) {
          ...
          if (u && o) throw new S.InvalidArgument("bulkAdd(): keys argument invalid on tables with inbound keys");
        ...
        return this._trans("readwrite", function(a) {
          var u = r.schema.primKey, m = u.auto, u = u.keyPath;
          if (u && o) throw new S.InvalidArgument("bulkPut(): keys argument invalid on tables with inbound keys");
          if (o && o.length !== e.length) throw new S.InvalidArgument("Arguments objects and keys must have the same length");
          var l = e.length, m = u && m ? e.map(Ot(u)) : e;
              ...
              if (c) {
                for (var v = 0, b = Object.keys(h); v < b.length; v++) {
                  ...
                  if (y === t.schema.primKey.keyPath) {
                    if (B(g, p) !== 0) throw new S.Constraint("Cannot update primary key in bulkUpdate()");
                  } else ne(c, y, g);
                }
      ...
      function it(e) {
        ...
        function i(a, u, l) {
          ...
          z(m = a).forEach(function(s) {
            var d = m[s];
            if (F(d)) i(s, m[s][0], m[s][1]);
            else {
              if (d !== "asap") throw new S.InvalidArgument("Invalid event config");
      ...
      function Et(e, t) {
        ...
        if (n) return n;
        throw new S.Schema("KeyPath " + e.index + " on object store " + t.name + " is not indexed");
      }
      function Xn(e, t, n) {
        var r = Et(e, t.schema);
      ...
      L.prototype._read = function(e, t) {
        ...
        return this._write(function(r) {
          function o(c, v) {
            var b = v.failures;
            d += c - v.numFailures;
            for (var y = 0, g = z(b); y < g.length; y++) {
              var w = g[y];
              s.push(b[w]);
            }
          }
            ...
            function v(y) {
              ...
              return (h ? Promise.resolve([]) : a.getMany({ trans: r, keys: w, cache: "immutable" })).then(function(k) {
                ...
                if (!h) for (var x = 0; x < g; ++x) {
                  var j = k[x], M = { value: Pe(j), primKey: c[y + x] };
                  i.call(M, M.value, M) !== !1 && (M.value == null ? C.push(c[y + x]) : u || B(l(j), l(M.value)) === 0 ? (_.push(M.value), u && K.push(c[y + x])) : (C.push(c[y + x]), O.push(M.value)));
                }
        ...
        return p._addAlgorithm(function(c, v, b) {
          ...
          if (typeof y == "string") {
            ...
            for (var w = null, k = h; k < s; ++k) {
              var O = ((_, K, C, x, j, M) => {
                for (var U = Math.min(_.length, x.length), D = -1, q = 0; q < U; ++q) {
                  var W = K[q];
                  if (W !== x[q]) return j(_[q], C[q]) < 0 ? _.substr(0, q) + C[q] + C.substr(q + 1) : j(_[q], x[q]) < 0 ? _.substr(0, q) + x[q] + C.substr(q + 1) : 0 <= D ? _.substr(0, D) + K[D] + C.substr(D + 1) : null;
                  j(_[q], W) < 0 && (D = q);
                }
                return U < x.length && M === "next" ? _ + C.substr(_.length) : U < _.length && M === "prev" ? _.substr(0, C.length) : D < 0 ? null : _.substr(0, D) + x[D] + C.substr(D + 1);
              })(y, g, u[k], l[k], a, m);
      ...
      Object.defineProperty(Z.prototype, "Collection", { get: function() {
        ...
        })) return oe(this, "First argument to inAnyRange() must be an Array of two-value Arrays [lower,upper] where upper must not be lower than lower", S.InvalidArgument);
      ...
      var st = "storagemutated", an = "x-storagemutated-1", xe = it(null, st), Lr = (ce.prototype._lock = function() {
        ...
        if (this.mode) {
          ...
          Xe(this._completion._state === null), (e = this.idbtrans = e || (this.db.core || n).transaction(this.storeNames, this.mode, { durability: this.chromeTransactionDurability })).onerror = Y(function(o) {
            ...
            ut(o), t.active && t._reject(new S.Abort(e.error)), t.active = !1, t.on("abort").fire(o);
        ...
        var r, o = this;
        return e === "readwrite" && this.mode !== "readwrite" ? G(new S.ReadOnly("Transaction is readonly")) : this.active ? this._locked() ? new E(function(i, a) {
          ...
          var u = t(i, a, o);
          u && u.then && u.then(i, a);
        }))._lib = !0, r) : G(new S.TransactionInactive());
        ...
        function o(f) {
          ...
          return { name: d, schema: f, mutate: function(p) {
            ...
            return new Promise(function(g, w) {
              ...
              var j = [], M = [], U = 0;
              if (c === "deleteRange") {
                if (y.type === 4) return g({ numFailures: U, failures: M, results: [], lastResult: void 0 });
                y.type === 3 ? j.push(K = k.clear()) : j.push(K = k.delete(r(y)));
              } else {
                var O = _ ? O ? [b, v] : [b, null] : [v, null], D = O[0], q = O[1];
                if (_) for (var W = 0; W < C; ++W) j.push(K = q && q[W] !== void 0 ? k[c](D[W], q[W]) : k[c](D[W])), K.onerror = x;
                else for (W = 0; W < C; ++W) j.push(K = k[c](D[W])), K.onerror = x;
              }
              function ie(Q) {
                Q = Q.target.result, j.forEach(function(qe, Cn) {
                  return qe.error != null && (M[Cn] = qe.error);
                }), g({ numFailures: U, failures: M, results: c === "delete" ? v : j.map(function(qe) {
                  return qe.result;
                }), lastResult: Q });
              }
            ...
            return new Promise(function(v, b) {
              ...
              }, C = se(b), x = 0; x < w; ++x) c[x] != null && ((y = g.get(c[x]))._pos = x, y.onsuccess = K, y.onerror = C, ++O);
              O === 0 && v(k);
            });
          }, get: function(p) {
            ...
            return new Promise(function(h, c) {
              ...
              }, O.onerror = se(c)) : (v = 0, b = !g && "openKeyCursor" in _ ? _.openKeyCursor(K) : _.openCursor(K), y = [], b.onsuccess = function(C) {
                var x = b.result;
            ...
            return new Promise(function(g, w) {
              ...
              K.onerror = se(w), K.onsuccess = Y(function(C) {
                var x, j, M, U, D = K.result;
                D ? (D.___id = ++Ur, D.done = !1, x = D.continue.bind(D), j = (j = D.continuePrimaryKey) && j.bind(D), M = D.advance.bind(D), U = function() {
                  ...
                  var ie = new Promise(function(Q, qe) {
                    Q = Y(Q), K.onerror = se(qe), D.fail = qe, D.stop = function(Cn) {
                      D.stop = D.continue = D.continuePrimaryKey = D.advance = U, Q(Cn);
                    };
                  });
                  return K.onsuccess = Y(function(Q) {
                    K.onsuccess = W, W();
                  }), D.continue = x, D.continuePrimaryKey = j, D.advance = M, W(), ie;
                }, g(D)) : g(null);
              }, w);
            });
          }, count: function(p) {
            ...
            return (v = v.filter(function(y) {
              ...
              c.push(function() {
                var g, w, k, O = b, _ = y._cfg.dbschema, K = (Dt(s, O, h), Dt(s, _, h), b = s._dbSchema = _, fn(O, _)), C = (K.add.forEach(function(x) {
                  ...
                  if (x.recreate) throw new S.Upgrade("Not yet support for changing primary key");
                  var j = h.objectStore(x.name);
                  x.add.forEach(function(M) {
                    return St(j, M);
                  }), x.change.forEach(function(M) {
                    j.deleteIndex(M.name), St(j, M);
                  }), x.del.forEach(function(M) {
                    return j.deleteIndex(M);
                  });
                }), y._cfg.contentUpgrade);
                if (C && y._cfg.version > d) return jt(s, h), p._memoizedTables = {}, g = An(_), K.del.forEach(function(x) {
                  g[x] = O[x];
                }), ln(s, [s.Transaction.prototype]), It(s, [s.Transaction.prototype], z(g), g), p.schema = g, (w = $t(C)) && $e(), _ = E.follow(function() {
                  var x;
      ...
      Qe.prototype._createTableSchema = sn, Qe.prototype._parseIndexSyntax = ir, Qe.prototype._parseStoresSpec = function(e, t) {
        ...
        z(e).forEach(function(r) {
          if (e[r] !== null) {
            ...
            if (!i) throw new S.Schema("Invalid schema for table " + r + ": " + e[r]);
            if (i.unique = !0, i.multi) throw new S.Schema("Primary key cannot be multiEntry*");
            o.forEach(function(a) {
              if (a.auto) throw new S.Schema("Only primary key can be marked as autoIncrement (++)");
              if (!a.keyPath) throw new S.Schema("Index must have a name and cannot be an empty string");
        ...
        }), t._dbSchema = o, ln(t, [t._allTables, t, t.Transaction.prototype]), It(t, [t._allTables, t, t.Transaction.prototype, this._cfg.tables], z(o), o), t._storeNames = z(o), this;
      ...
      function ft(e, t, n) {
        ...
        if (!isNaN(r)) {
          ...
          var r = e.l, o = e.r;
          if (B(n, e.from) < 0) return r ? ft(r, t, n) : e.l = { from: t, to: n, d: 1, l: null, r: null }, ur(e);
          if (0 < B(t, e.to)) return o ? ft(o, t, n) : e.r = { from: t, to: n, d: 1, l: null, r: null }, ur(e);
          B(t, e.from) < 0 && (e.from = t, e.l = null, e.d = o ? o.d + 1 : 1), 0 < B(n, e.to) && (e.to = n, e.r = null, e.d = e.l ? e.l.d + 1 : 1), t = !e.r, r && !e.l && ht(e, r), o && t && ht(e, o);
        }
      }
      function ht(e, t) {
        mn(t) || (function n(r, o) {
      ...
      function ar(e, t) {
        ...
        if (!r.done) for (var o = r.value, i = Rt(e), a = i.next(o.from), u = a.value; !r.done && !a.done; ) {
          ...
          B(o.from, u.from) < 0 ? o = (r = n.next(u.from)).value : u = (a = i.next(o.from)).value;
        }
        return !1;
      }
      function Rt(e) {
      ...
      function Gr(e) {
        ...
        function a() {
          if (t.openCanceller !== r) throw new S.DatabaseClosed("db.open() was cancelled");
        }
        function u() {
          return new E(function(d, p) {
            if (a(), !n) throw new S.MissingAPI();
            var h = e.name, c = t.autoSchema || !o ? n.open(h) : n.open(h, o);
            if (!c) throw new S.MissingAPI();
            c.onerror = se(p), c.onblocked = Y(e._fireOnBlocked), c.onupgradeneeded = Y(function(v) {
              ...
              f = c.transaction, t.autoSchema && !e._options.allowEmptyDB ? (c.onerror = ut, f.abort(), c.result.close(), (b = n.deleteDatabase(h)).onsuccess = b.onerror = Y(function() {
                p(new S.NoSuchDatabase("Database ".concat(h, " doesnt exist")));
              ...
              if (0 < _.length) try {
                ...
                if (t.autoSchema) k = O, g = K, (y = e).verno = k.version / 10, g = y._dbSchema = At(0, k, g), y._storeNames = dt(k.objectStoreNames, 0), It(y, [y._allTables], z(g), g);
        ...
        return E.race([r, (typeof navigator > "u" ? E.resolve() : !navigator.userAgentData && /Safari\//.test(navigator.userAgent) && !/Chrom(e|ium)\//.test(navigator.userAgent) && indexedDB.databases ? new Promise(function(d) {
          ...
          return a(), t.onReadyBeingFired = [], E.resolve(yn(function() {
            ...
            var p;
            if (0 < t.onReadyBeingFired.length) return p = t.onReadyBeingFired.reduce(Yt, $), t.onReadyBeingFired = [], E.resolve(yn(function() {
              return p(e.vip);
            })).then(d);
          });
        }).finally(function() {
      ...
      function lr(e, t, n) {
        try {
          ...
          for (var r = [], o = 0, i = 0; o < t.keys.length && i < e.length; ++o) B(t.keys[o], e[i]) === 0 && (r.push(n ? Pe(t.values[o]) : t.values[o]), ++i);
      ...
      var Zr = { stack: "dbcore", level: 0, name: "Observability", create: function(e) {
        ...
        return P(P({}, e), { transaction: function(r, o, i) {
          ...
          var i = e.table(r), a = i.schema, u = a.primaryKey, l = a.indexes, m = u.extractKey, f = u.outbound, s = u.autoIncrement && l.filter(function(h) {
            ...
            return F(K) ? (k.addKeys(K), (_ = _ === "delete" || K.length === C.length ? lr(K, x) : null) || O.addKeys(K), (_ || C) && (v = c, b = _, y = C, a.indexes.forEach(function(j) {
              var M = v(j.name || "");
              function U(q) {
                return q != null ? j.extractKey(q) : null;
              }
              function D(q) {
                j.multiEntry && F(q) ? q.forEach(function(W) {
                  return M.addKey(W);
                }) : M.addKey(q);
              }
              (b || y).forEach(function(q, Q) {
                var ie = b && U(b[Q]), Q = y && U(y[Q]);
                B(ie, Q) !== 0 && (ie != null && D(ie), Q != null) && D(Q);
              });
              ...
              return !K || h.type !== "add" && h.type !== "put" || (k.addKeys(j.results), s && s.forEach(function(M) {
                for (var U = h.values.map(function(ie) {
                  return M.extractKey(ie);
                }), D = M.keyPath.findIndex(function(ie) {
                  return ie === u.keyPath;
                }), q = 0, W = j.results.length; q < W; ++q) U[q][D] = j.results[q];
                c(M.name).addKeys(U);
                ...
                if ((h === "query" && O.isPrimaryKey && !c.values ? k : v(O.name || "")).add(b), !O.isPrimaryKey) {
                  if (h !== "count") return g = h === "query" && f && c.values && i.query(P(P({}, c), { values: !1 })), i[h].apply(this, arguments).then(function(C) {
                    if (h === "query") {
                      ...
                      var j, M;
                      if (h === "openCursor") return M = c.values, (j = C) && Object.create(j, { key: { get: function() {
                        return k.addKey(j.primaryKey), j.key;
                      } }, primaryKey: { get: function() {
                        var U = j.primaryKey;
                        return k.addKey(U), U;
                      } }, value: { get: function() {
                        return M && w.addKey(j.primaryKey), j.value;
                      } } });
                    }
                    return C;
                  });
      ...
      function pr(e, t, n, r, o, i) {
        ...
        return !n || n.length === 0 || (a = t.query.index, u = a.multiEntry, l = t.query.range, m = r.schema.primaryKey.extractKey, f = a.extractKey, s = (a.lowLevelIndex || a).extractKey, (r = n.reduce(function(d, p) {
          ...
          if (p.type === "add" || p.type === "put") for (var v = new ee(), b = p.values.length - 1; 0 <= b; --b) {
            ...
            !v.hasKey(w) && (y = f(g), u && F(y) ? y.some(function(C) {
              return On(C, l);
      ...
      H.prototype.version = function(e) {
        ...
        return this.idbdb && (this._state.openComplete || I.letThrough || this._vip) ? e() : new E(function(n, r) {
          ...
          if (!t._state.isBeingOpened) {
            if (!t._state.autoOpen) return void r(new S.DatabaseClosed());
            t.open().catch($);
          }
        ...
        t ? (n.isBeingOpened && n.cancelOpen(new S.DatabaseClosed()), this._close(), n.autoOpen = !1, n.dbOpenError = new S.DatabaseClosed()) : (this._close(), n.autoOpen = this._options.autoOpen || n.isBeingOpened, n.openComplete = !1, n.dbOpenError = null);
        ...
        return new E(function(o, i) {
          ...
          if (n) throw new S.InvalidArgument("Invalid closeOptions argument to db.delete()");
        ...
        try {
          if (o = t.map(function(m) {
            ...
            if (e != "rw" && e != nn) throw new S.InvalidArgument("Invalid transaction mode: " + e);
            r = nn;
          }
          if (a) {
            if (a.mode === tn && r === nn) {
            ...
            a && o.forEach(function(m) {
              if (a && a.storeNames.indexOf(m) === -1) {
                if (!u) throw new S.SubTransaction("Table " + m + " not included in parent transaction.");
                a = null;
              }
            }), u && a && !a.active && (a = null);
          }
        ...
        var l = function m(f, s, d, p, h) {
          return E.resolve().then(function() {
            ...
            var v, b = $t(h), y = (b && $e(), E.follow(function() {
              var g;
            ...
            return (v && typeof v.then == "function" ? E.resolve(v).then(function(g) {
              return c.active ? g : G(new S.PrematureCommit("Transaction committed too early. See http://bit.ly/2kdckMn"));
            }) : y.then(function() {
              return v;
            })).then(function(g) {
      ...
      function H(e, t) {
        var n, r, o, i, a, u = this, l = (this._middlewares = {}, this.verno = 0, H.dependencies), l = (this._options = t = P({ addons: H.addons, autoOpen: !0, indexedDB: l.indexedDB, IDBKeyRange: l.IDBKeyRange, cache: "cloned" }, t), this._deps = { indexedDB: t.indexedDB, IDBKeyRange: t.IDBKeyRange }, t.addons), m = (this._dbSchema = {}, this._versions = [], this._storeNames = [], this._allTables = {}, this.idbdb = null, this._novip = this, { dbOpenError: null, isBeingOpened: !1, onReadyBeingFired: null, openComplete: !1, dbReadyResolve: $, dbReadyPromise: null, cancelOpen: $, openCanceller: null, autoSchema: !0, PR1398_maxLoop: 3, autoOpen: t.autoOpen }), f = (m.dbReadyPromise = new E(function(s) {
          ...
          this.db = r, this._tx = p, this.name = s, this.schema = d, this.hook = r._allTables[s] ? r._allTables[s].hook : it(null, { creating: [jr, $], reading: [Kr, Ze], updating: [Sr, $], deleting: [Ir, $] });
          ...
          if (this.db = a, this._ctx = { table: s, index: d === ":id" ? null : d, or: p }, this._cmp = this._ascending = B, this._descending = function(h, c) {
            return B(c, h);
          }, this._max = function(h, c) {
            return 0 < B(h, c) ? h : c;
          }, this._min = function(h, c) {
            return B(h, c) < 0 ? h : c;
          }, this._IDBKeyRange = a._deps.IDBKeyRange, !this._IDBKeyRange) throw new S.MissingAPI();
      ...
      try {
        Mt = { indexedDB: A.indexedDB || A.mozIndexedDB || A.webkitIndexedDB || A.msIndexedDB, IDBKeyRange: A.IDBKeyRange || A.webkitIDBKeyRange };
      } catch {
      ...
      }, shallowClone: An, deepClone: Pe, getObjectDiff: xn, cmp: B, asap: Sn, minKey: -1 / 0, addons: [], connections: Ve, errnames: Vt, dependencies: Mt, cache: Re, semVer: "4.3.0", version: "4.3.0".split(".").map(function(e) {
        return parseInt(e);
      ...
      return typeof BroadcastChannel < "u" && ((vr = function() {
        ...
        return new ot({ add: e });
      }, cmp: B, default: pe, liveQuery: mr, mergeRanges: ht, rangesOverlap: ar, remove: function(e) {
...
const {
  ...
  vendorHomeURL: Eo,
  version: Co
}, jo = "0.2.239", Io = "Encountered invalid container identifier", Ft = "Encountered invalid folder path", So = "Encountered invalid object path";
class zo {
  abortController;
  config;
  engineUtilities;
  ...
  containers;
  constructor(R, N) {
    this.abortController = void 0, this.config = Ko, this.config.version = jo, this.engineUtilities = R, this.toolConfigs = N, this.containers = {};
  }
  // Abort operation
  abortOperation() {
  ...
  async createObject(R) {
    console.log("CO 1");
    const { containerId: N, nodeId: P } = this.establishObjectIdentifiers(R.path), T = await this.establishContainer(N);
    if (console.log("CO 2"), T.tables.some((F) => F.name === P)) throw new Error(`Duplicate table '${P}'.`);
    console.log("CO 3"), T.close();
    const A = new Oe(T.name);
    A.on("blocked", () => !1), console.log("CO 4");
    const z = {};
    for (const { name: F, schema: X } of T.tables)
      z[F] = [X.primKey.src, ...X.indexes.map((ae) => ae.src)].join(",");
    A.version(T.verno).stores(z), A.version(T.verno + 1).stores({ [P]: R.structure || "" }), this.containers[N] = await A.open(), console.log("CO 5");
  }
  // Drop object
  async dropObject(R) {
    const { containerId: N, nodeId: P } = this.establishObjectIdentifiers(R.path), T = await this.establishContainer(N);
    if (!T.tables.some((F) => F.name === P)) throw new Error(`Table '${P}' not found.`);
    T.close();
    const A = new Oe(T.name);
    if (A.on("blocked", () => !1), T.tables.length === 1) {
      await T.delete(), A.version(1).stores({}), this.containers[N] = await A.open();
      return;
    }
    const z = {};
    for (const { name: F, schema: X } of T.tables)
      z[F] = [X.primKey.src, ...X.indexes.map((ae) => ae.src)].join(",");
    A.version(T.verno).stores(z), A.version(T.verno + 1).stores({ [P]: null }), this.containers[N] = await A.open();
  }
  // Find object
  async findObject(R) {
    if (console.log("findObject 1", R), R.containerId == null) throw new Error(`${Io} '${R.containerId}'.`);
    const P = (await this.establishContainer(R.containerId)).tables.find((T) => T.name === R.nodeId);
    return console.log("findObject 2", P), { folderPath: R.containerId, object: P };
  }
  // Get record
  async getRecord(R) {
    const { containerId: N, nodeId: P } = this.establishObjectIdentifiers(R.path), A = await (await this.establishContainer(N)).table(P).get(R.id);
    if (A) return { record: A };
    throw new Error("Not found.");
  }
  // List nodes
  async listNodes(R) {
    const N = R.folderPath.split("/");
    switch (N.length) {
      case 1: {
        if (N[0] != null) throw new Error(`${Ft} '${R.folderPath}'.`);
        const T = (await Oe.getDatabaseNames()).map(
          (A) => ({ folderPath: R.folderPath, id: A, label: A, name: A, typeId: "folder" })
        );
      ...
      case 2: {
        ...
        const A = (await this.establishContainer(P)).tables.map(
          (z) => ({ folderPath: R.folderPath, id: z.name, label: z.name, name: z.name, typeId: "object" })
        );
        return { cursor: void 0, isMore: !1, connectionNodeConfigs: A, totalCount: A.length };
      }
      default:
  ...
  async previewObject(R) {
    const { containerId: N, nodeId: P } = this.establishObjectIdentifiers(R.path);
    return await (await this.establishContainer(N)).table(P).limit(50).toArray(), {
      asAt: Date.now(),
      columnConfigs: [],
  ...
  async upsertRecords(R) {
    const { containerId: N, nodeId: P } = this.establishObjectIdentifiers(R.path), T = await this.establishContainer(N), A = R.records;
    A.length === 1 ? await T.table(P).put(A[0]) : A.length > 1 && await T.table(P).bulkPut(A);
  }
  // Remove records
  async removeRecords(R) {
    const { containerId: N, nodeId: P } = this.establishObjectIdentifiers(R.path), T = await this.establishContainer(N), A = R.keys;
    A.length === 0 ? await T.table(P).clear() : A.length === 1 && A[0] != null ? await T.table(P).delete(A[0]) : await T.table(P).bulkDelete(A);
  }
  // Retrieve records
  async retrieveRecords(R, N, P) {
    const { containerId: T, nodeId: A } = this.establishObjectIdentifiers(R.path), F = await (await this.establishContainer(T)).table(A).toArray();
    console.log("retrieveRecords", F);
  }
  // Helpers ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  async establishContainer(R) {
    if (!this.containers[R]) {
      const N = new Oe(R);
      await Oe.exists(N.name) || N.version(1).stores({}), this.containers[R] = await N.open();
    }
    return this.containers[R];
  }
  establishObjectIdentifiers(R) {
    const N = R.split("/"), [, P, T] = N;
    if (N.length !== 3 || P === void 0 || P === "" || T === void 0 || T === "")
      throw new Error(`${So} '${R}'.`);
