...
const {
  ...
  vendorHomeURL: Eo,
  version: Ko
}, Co = "0.2.248", Io = "Encountered invalid container identifier", Ft = "Encountered invalid folder path", So = "Encountered invalid object path";
class $o {
  abortController;
  config;
  engineUtilities;
