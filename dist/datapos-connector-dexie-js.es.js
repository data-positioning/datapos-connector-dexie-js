...
class Vo {
  ...
  async retrieveRecords(R, q, P) {
    try {
      ...
      q(M), P({ byteCount: 0, commentLineCount: 0, emptyLineCount: 0, lineCount: 0, nonUniformRecordCount: 0, recordCount: M.length });
    } catch (T) {
