...
const {
  ...
  vendorHomeURL: Eo,
  version: Ko
}, Co = "0.2.227", So = "Encountered invalid container identifier", Ft = "Encountered invalid folder path", Io = "Encountered invalid object path";
class zo {
  abortController;
  config;
  engineUtilities;
